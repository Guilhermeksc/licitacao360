...
def load_and_map_icons(icons_dir, image_cache):
    ...
    icon_mapping = {
        ...
        'Mensagem_azul': 'Mensagem_azul.png',
        'API': 'api.png',
        'API_azul': 'api_azul.png',
        'excel': 'excel.png',
        'excel_azul': 'excel_azul.png',
        'data-server': 'data-server.png',
        'data-server_azul': 'data-server_azul.png',
        'statistics': 'statistics.png',
        'statistics_azul': 'statistics_azul.png',
        'external-link': 'external-link.png',
        'external-link_azul': 'external-link_azul.png',
        'download-pdf': 'download-pdf.png',
