...
class SaveTableDialog(QDialog):
    ...
    def excluir_database(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            backup_path = os.path.join(desktop_path, "controle_processos_backup.xlsx")
            ...
            try:
                ...
                cursor.close()
                conn.close()
                QMessageBox.information(self, "Sucesso", "Tabela 'controle_processos' excluída com sucesso!")
