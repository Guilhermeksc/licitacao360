...
from modules.dispensa_eletronica.documentos_cp_dfd_tr import load_config_path_id
...
class EditDataDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        # Gerenciador de Stacked Widgets
    ...
    def setup_stacked_widgets(self):
        ...
        widgets = {
            "Informações Gerais": self.stacked_widget_info("Detalhes da Contratação"),
            "Setor Responsável": self.stacked_widget_responsaveis("Setor Responsável"),
            "Documentos": self.stacked_widget_documentos("Documentos de Planejamento"),
        }
    ...
    def stacked_widget_info(self, label_text):
    ...
    def stacked_widget_responsaveis(self, label_text):
        # Cria um widget básico para o stack
        frame = QFrame()
        layout = QVBoxLayout()
        layout.addWidget(QLabel(label_text))
    ...
    def stacked_widget_documentos(self, label_text):
        # Cria um widget básico para o stack
        frame = QFrame()
        layout = QVBoxLayout()
        layout.addWidget(QLabel(label_text))
    ...
    def update_title_label_text(self, text):
        # Atualiza o texto do título
        self.title_label.setText(text)

    def update_title_label(self):
        self.title_label = QLabel("Título Atual")
    ...
    def create_contratacao_group(self):
        group_box = QGroupBox("Informações de Contratação", self)

        layout = QVBoxLayout()
        label_contratacao = QLabel("Detalhes da Contratação")
        layout.addWidget(label_contratacao)
